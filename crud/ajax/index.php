	      ...
	      <div class="modal-body">
				...
				<div id="inputemail">
					<div class="form-group">
						<br>
						<div id="rowNew">
							<button id="rowadd" type="button" class="btn btn-info">Add Row</button>
						</div>
					</div>
				</div>
				<div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  	<div class="form-group">
				...
				<input type="text" class="form-control" name="username" id="upd_1" placeholder="enter your name">
				<span class="error-msg" id="umsg_1"></span>
		  	</div>
		  	<div class="form-group">
				<label><b>Email</b></label>
				<input type="text" class="form-control" name="email" id="upd_2" placeholder="enter your email">
...
$("#addRow").click(function () {
            ...
            html += '<input type="text" name="username" class="form-control" placeholder="enter your name">';
			html += '<br>';
...
$("#rowadd").click(function () {
            var html = '';
            html += '<div id="inputemail">';
            html += '<div class="form-group">';
            html += '<input type="text" name="email" class="form-control" placeholder="enter your email">';
			html += '<br>';
            html += '<div class="input-group-append">';
            html += '<button id="rowRemove" type="button" class="btn btn-danger">Remove</button>';
            html += '</div>';
            html += '</div>';
